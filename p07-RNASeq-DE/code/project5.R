...
hbr1 <- as.data.frame(fread("/blah/blah/blah/project5/HBR_Rep1ReadsPerGene.out.tab", skip=4))
hbr2 <- as.data.frame(fread("/blah/blah/blah/project5/HBR_Rep2ReadsPerGene.out.tab", skip=4))
uhr1 <- as.data.frame(fread("/blah/blah/blah/project5/UHR_Rep1ReadsPerGene.out.tab", skip=4))
uhr2 <- as.data.frame(fread("/blah/blah/blah/project5/UHR_Rep2ReadsPerGene.out.tab", skip=4))
...
allequal(hbr1$V1, hbr2$V1) # Returns TRUE
allequal(hbr1$V1, uhr1$V1) # Returns TRUE
allequal(hbr1$V1, uhr2$V1) # Returns TRUE
expr <- # YOUR CODE TO COMBINE THE FOUR DATA FRAMES GOES HERE (hint: use cbind)
